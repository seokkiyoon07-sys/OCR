        ...
        <body>
          <div class="report-container">
            ...
            <div class="student-info">
              <div class="info-grid">
                <div class="info-cell">
                  <div class="info-label">수험번호</div>
                  <div class="info-value">STU_강동호</div>
                </div>
                <div class="info-cell">
                  <div class="info-label">성명</div>
                  <div class="info-value">강동호</div>
                </div>
                <div class="info-cell">
                  <div class="info-label">성별</div>
                  <div class="info-value">남</div>
                </div>
                <div class="info-cell">
                  <div class="info-label">반</div>
                  <div class="info-value">1반</div>
                </div>
              </div>
              ...
              <div class="info-grid">
                <div class="info-cell">
                  ...
                  <div class="info-value">2008-03-15</div>
                </div>
                <div class="info-cell">
                  <div class="info-label">시·도</div>
                  <div class="info-value">서울</div>
                </div>
                <div class="info-cell">
                  <div class="info-label">학교명(학원명)</div>
                  <div class="info-value">SN독학기숙학원</div>
                </div>
                <div class="info-cell">
              ...
              <table class="score-table">
                <thead>
                  <tr>
                    ...
                    <th>
                      국어<br/>
                      <span style="font-size: 10px; color: #666; font-weight: normal;">화법과 작문</span>
                    </th>
                    <th>
                      수학<br/>
                      <span style="font-size: 10px; color: #666; font-weight: normal;">미분과 적분</span>
                    </th>
                    <th>영어</th>
                    <th>생활과윤리</th>
                    <th>사회문화</th>
            ...
            <div class="wrong-answers">
              ...
              <div class="wrong-item">
                <span class="wrong-label">한국사:</span>
                <span class="wrong-value">—</span>
              </div>
              <div class="wrong-item">
                <span class="wrong-label">국어(언어와 매체):</span>
                <span class="wrong-value">11, 12, 13, 15, 16, 17, 23, 26</span>
              </div>
              <div class="wrong-item">
                <span class="wrong-label">수학(미적분):</span>
                <span class="wrong-value">21, 22, 29</span>
              </div>
              <div class="wrong-item">
                <span class="wrong-label">영어:</span>
                <span class="wrong-value">30, 31</span>
              </div>
              <div class="wrong-item">
                <span class="wrong-label">생활과윤리:</span>
                <span class="wrong-value">—</span>
              </div>
              <div class="wrong-item">
                <span class="wrong-label">사회문화:</span>
                <span class="wrong-value">—</span>
              </div>
              <div class="wrong-item">
                <span class="wrong-label">제2외국어·한문:</span>
                <span class="wrong-value">—</span>
              </div>
            </div>
